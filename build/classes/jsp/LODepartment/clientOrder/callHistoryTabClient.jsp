		...
		<table width="100%" >
			<tr>
				<td width="300px">
					...
					<h:inputText id="searchCallClieText" value="#{clienOrderControl.filtroCallHistory }" onkeydown="if(event.keyCode == 13){ #{rich:element('searchCallClieButton') }.click() ; }">
					</h:inputText>
					<a4j:commandButton id="searchCallClieButton" value="Search" action="#{clienOrderControl.filterClientCallsHistoryAction}" reRender="callClieDataTable" />
				</td>
				<td>
					<a4j:commandButton value="Print Selected" />
				</td>
				<td align="right" valign="bottom">
					<a4j:commandLink id="newCallClieLink" value="Add Note" style="font-size:11px;" 
			...
			<tr>
				<td colspan="3">
					<rich:extendedDataTable id="callClieDataTable"
						height="351px" width="100%" rowClasses="row1,row2"
						value="#{clienOrderControl.callsHistoryClientFiltered}" var="call"
						rows="13" sortMode="#{clienOrderControl.sortMode}"
						title="Calls History" binding="#{clienOrderControl.tableCallHistClie}"
						reRender="ds2">	
						...
						<f:facet name="footer">
							<rich:datascroller id="ds2" align="center" status="none"
								for="callClieDataTable" maxPages="50" />
						</f:facet>
