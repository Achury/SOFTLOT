...
public class currencyDollarConverter implements Converter {

	private Log log = LogFactory.getLog(currencyDollarConverter.class);
	private DecimalFormat formatter = new DecimalFormat("####0.00");
	
	public currencyDollarConverter(){
